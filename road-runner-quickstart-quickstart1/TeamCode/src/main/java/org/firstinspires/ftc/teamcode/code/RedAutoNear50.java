...
@Autonomous (name = "Red 50 Near")
public class RedAutoNear50 extends LinearOpMode {
        ...
        switch(position){
            case right:
                ...
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d(18, -12, Math.toRadians(-90)))
                        .lineToSplineHeading(new Pose2d(19.5, -33, Math.toRadians(-90)))
                        .build()
                );
                ...
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d(19.5, -33, Math.toRadians(-90)))
                        .strafeRight(14.5)
                        .build()
                );
            ...
            case center:
                ...
                sleep(1000);
                arm_controller.set_slide_target(0);
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d(24, -15, Math.toRadians(-90)))
                        .strafeRight(18)
                        .build()
                );
                arm_controller.set_slide_target(0);
...
//                );
                ...
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d(18, -6 - 15, Math.toRadians(0)))
                        .lineToSplineHeading(new Pose2d(32, -33, Math.toRadians(-90)))
                        .build()
                );
                hw.clawPosServo.setPosition(RobotConstants.startPos + 110 * (v_over_d_claw) + (hw.armMotor.getCurrentPosition() * (1/t_over_d_arm)) * v_over_d_claw);
                sleep(1000);
                ...
                sleep(1000);
                arm_controller.set_slide_target(0);
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d(32, -33, Math.toRadians(-90)))
                        .strafeRight(28)
                        .build()
                );
                arm_controller.set_slide_target(0);
