...
@Autonomous (name = "Red 50 Near REAL")
public class RedAutoNear50True extends LinearOpMode {
        ...
        switch(position){
            case left:
                ...
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d())
                        .lineToSplineHeading(new Pose2d(-19, 0, Math.toRadians(-90)))
                        .build()
                );
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d(-19, 0, Math.toRadians(-90)))
                        .back(12)
                        .build()
                );
                ...
                drive.followTrajectory(drive.trajectoryBuilder(new Pose2d(-19, 12, Math.toRadians(-90)))
